...
if(MODE == "IATA"){
  ...
  opt <- list(out =paste0(BASEDIR, "Results_rstudio/results3_mouseDB_EvaExtraPlots/"),
              indir = paste0(BASEDIR, "/Results_cluster/Results2_mouseDB/mg09_combinempa_K2/") ,
              ...
              metadata = paste0(BASEDIR, "/Metadata/metadata_CM_noTransfer.xlsx"),
