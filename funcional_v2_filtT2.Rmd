...
if(exists("input")){
    ...
    opt <- list(fc=1, 
            ...
            mincount= 1,
            minsampleswithcount= 6,
            out= "/home/carlos/Escritorio/202311_DEPRESION/ReviewJune2025/Results_rstudio/results2/funcional_v1/", #"/home/carmoma/projects/Psoriasis_20231005/results2/",
...
plims <- c(0.015, 0.0005, 0.005, 0.001, 0.05, 0.05)
names(plims) <- names(limmares_byproc)
...
plims <- c(0.025, 0.0005, 0.005, 0.001, 0.05, 0.05)
names(plims) <- names(limmares_byproc)
plims_sp <- c(0.1, 0.01, 0.01, 0.01, 0.05, 0.05)
names(plims_sp) <- names(limmares_byproc)
